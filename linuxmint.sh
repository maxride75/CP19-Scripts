#!/bin/bash
#some code was generated by ai, the rest is either from my brain, Ubuntu Essentials book, or from the checklist
if (( EUID != 0 )); then
...
read -p "Does the README need extra user management? If so, mkdir group, create txt named group.txt and user.txt, self explanatory. User is mkdir user, user.txt."
